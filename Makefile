...
js/wasm32.js: js/wasm32-main.jsc.js js/wasm32-range.jsc.js js/wasm32-system.jsc.js js/wasm32-thinthin.jsc.js js/wasm32-boot.jsc.js build/wasm32/gcc.make
...
bin/wasmrewrite: wasmrewrite/wasmrewrite.c bin/.dir
	gcc -g3 $< -o $@

bin/wasmsect: wasmrewrite/wasmsect.c bin/.dir
	gcc -g3 $< -o $@
